...
public class SplitterGroup implements StudentGroup
{
  private Splitter maleDancer;
  ...
  // Constructor
  public SplitterGroup(DanceFloor df)
  {
    danceFloor = df;
  ...
  public void setup(int floorDir, Dance steps1, Dance steps2)
  {
    ...
    if (floorDir == 0)
    {
      maleDancer = new Splitter(x, y + Dancer.PIXELS_PER_INCH * 12, leftMansShoe, rightMansShoe);
      maleDancer.turnLeft();
    }
    else
    {
