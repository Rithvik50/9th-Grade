                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    Color brandColor1 = new Color(240, 30, 10); // r, g, b
    Color brandColor2 = new Color(255, 180, 0);
    Color brandColor3 = new Color(90, 180, 0);
    Color brandColor4 = new Color(20, 20, 180);
    ...
    machine4 = new VendingMachine("JBar", brandColor4, 75, coin);
  ...
  public static void main(String[] args)
  {
    ...
    window.setBounds(50, 50, 720, 310);
